...
function Navbar({ onMenuClick }) {
    ...
    return (
        <nav className="fixed top-0 left-0 right-0 h-14 bg-[#0f0f0f] border-b border-gray-800 z-50">
                    ...
                    {isAuthenticated ? (
                        <>
                            ...
                            <div className="relative" ref={dropdownRef}>
                                ...
                                {showDropdown && (
                                    <div className="absolute right-0 mt-2 w-48 bg-[#282828] rounded-lg shadow-lg py-2 border border-gray-700">
                        ...
                        <Link
                            to="/login"
                            className="flex items-center gap-2 border border-blue-500 text-blue-500 hover:bg-blue-500/10 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full transition-colors text-sm whitespace-nowrap"
                        >
                            Sign in
                        </Link>
                    )}
            ...
            {showMobileSearch && (
                <div className="md:hidden absolute top-14 left-0 right-0 bg-[#0f0f0f] border-b border-gray-800 p-3 z-40">
                    <form onSubmit={handleSearch} className="flex gap-2">
                        <input
                            ...
                            placeholder="Search"
                            autoFocus
                            className="flex-1 bg-[#121212] border border-gray-700 rounded-full px-4 py-2 text-white placeholder-gray-500 focus:border-blue-500 focus:outline-none"
                        />
                        <button
                            type="submit"
                        ...
                        <button
                            ...
                            className="bg-gray-800 hover:bg-gray-700 text-white px-4 rounded-full transition-colors text-sm"
                        >
                            Cancel
                        </button>
                    </form>
