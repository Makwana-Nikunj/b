...
import { initSocialLogin } from '../../utils/socialAuth'
...
function GoogleLoginButton({ className = '' }) {
    ...
    return (
        <button
            ...
            disabled={loading}
            className={`w-full flex items-center justify-center gap-3 px-4 py-3 bg-white hover:bg-gray-100 text-gray-800 font-medium rounded-lg border border-gray-300 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed ${className}`}
        >
            {loading ? (
